...
# CUDA_VISIBLE_DEVICES=0 python -u train_virtualhome.py --env_name "VirtualHome-v1" --algorithm_name "POAD" --experiment_name "full_scale" --num_env_steps 10000 --seed 10 --entropy_coef 0.001 --ppo_epoch 5 --num_mini_batch 2 --gradient_cp_steps 16 --model_name ${llama} --use_full_scale

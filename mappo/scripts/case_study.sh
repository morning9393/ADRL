...
CUDA_VISIBLE_DEVICES=0 python -u train_case_study.py --model_name ${tokenizer_path} --experiment_name "case_study" --algorithm_name "POAD" --seed 10 --num_env_steps 50000 --ppo_epoch 1 --num_mini_batch 8
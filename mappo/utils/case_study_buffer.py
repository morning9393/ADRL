...
class CriticBuffer(object):
    ...
    def insert_appo(self, obs, ava, actions, value_preds, rewards, masks, action_tokens):
        """
    ...
    def insert_tppo(self, obs, ava, actions, value_preds, rewards, masks, action_tokens):
        """
        Insert data into the buffer.
        """
        self.obs[self.cur_batch_index, self.step + 1] = obs.copy()
